    ...
    return (
      ...
      >
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-7xl">
            ...
            <span className="relative mt-2 block w-fit mx-auto">
              ...
              {/* Animated Text */}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-500 min-h-[1.2em] inline-block">
                {displayText}
        ...
        <div className="mt-10 flex flex-col items-center gap-6">
          {/* Info Badge */}
          {infoBadgeText && (
            <div className="inline-flex items-center rounded-lg bg-zinc-900/80 border border-zinc-800 text-emerald-400 px-3 py-1 text-xs font-semibold tracking-wide">
              {infoBadgeText}
            </div>
          )}
        </div>
