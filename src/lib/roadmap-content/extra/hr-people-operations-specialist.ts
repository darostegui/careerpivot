  ...
  topics: [
    {
      ...
      studyPlan: [
        "Interview employees and managers about friction, accessibility, and emotional stakes.",
        "Map systems, approvals, service levels, ownership, and exceptions.",
        "Pilot one handoff and revise communications from feedback."
      ],
    ...
    },
    {
      ...
      studyPlan: [
        "Define fields by purpose, source, sensitivity, owner, retention, and correction.",
        "Reconcile synthetic records and test access, duplicates, exports, and small cells.",
        "Explain privacy choices and limits to a non-technical leader."
      ],
    ...
    },
    {
      ...
      studyPlan: [
        "Practice neutral intake, confidentiality limits, evidence chronology, conflicts, and anti-retaliation.",
        "Separate listening, fact-finding, advising, and decision authority.",
        "Write outcome and support communications with dignity."
      ],
    ...
    },
    {
      ...
      studyPlan: [
        "Define observable outcomes and behaviors with the employee.",
        "Practice feedback and development with evidence and a next step.",
        "Audit consistency, accessibility, bias risk, and employee voice."
      ],
    ...
    },
    {
      ...
      studyPlan: [
        "Frame a people question before opening synthetic data.",
        "Check missingness, representation, small cells, and alternatives.",
        "Present uncertainty and a reversible intervention with an unintended-effects check."
      ],
